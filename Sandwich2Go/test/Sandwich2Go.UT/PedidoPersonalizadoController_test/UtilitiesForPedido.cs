...
namespace Sandwich2Go.UT.PedidoPersonalizadoController_test
{
    public class UtilitiesForPedido
    {
        ...
        static IList<SandwCreado> SandwichesG;
        ...
        public static IList<SandwCreado> GetSandwiches(int index, int numOfSandwiches)
        {
        ...
        public static void CrearDatos()
        {
            ...
            SandwichesG = new List<SandwCreado>();
            ...
            SandwichesG.Add(new SandwCreado { Id = 1, SandwichName = "Cubano", Precio = 5.50, Desc = "Queso, jamón y mayonesa", OfertaSandwich = new List<OfertaSandwich>() });
