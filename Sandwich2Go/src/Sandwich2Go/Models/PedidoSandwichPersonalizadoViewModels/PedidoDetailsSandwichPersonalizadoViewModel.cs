...
namespace Sandwich2Go.Models.PedidoSandwichPersonalizadoViewModels
{
        ...
        public class PedidoDetailsSandwichPersonalizadoViewModel
        {
            ...
            public PedidoDetailsSandwichPersonalizadoViewModel(Pedido p)
            {
            ...
            {
                return obj is PedidoDetailsSandwichPersonalizadoViewModel model &&
